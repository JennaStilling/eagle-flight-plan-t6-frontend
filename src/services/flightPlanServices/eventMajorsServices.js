...
export default {
  createEventMajor(eventId, majorId, data) {
    return apiClient.post(
      `flightPlan-t6/event/${eventId}/major/${majorId}/eventMajor`,
      data
    );
  },
  getAllEventMajors() {
  ...
  getEventMajor(eventId, majorId, id, data) {
    return apiClient.post(
      `flightPlan-t6/event/${eventId}/major/${majorId}/eventMajor/${id}`,
      data
    );
  },
  ...
  getAllByEvent(id) {
    return apiClient.get(`flightPlan-t6/event/${id}/eventMajors`);
  },
};