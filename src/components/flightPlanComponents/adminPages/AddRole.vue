<template>
    <v-btn class="button" variant="elevated" color="#5EC4B6" @click="showAddRole()">
        Add Custom Role
    </v-btn>
            ...
            <div class="scroll">
                <v-sheet class="form">
                    <v-form ref="formReference" v-model="formValid">
                        ...
                        <v-card-actions>
                            <v-spacer />
                            <v-btn class="button" variant="elevated" color="#5EC4B6" @click="addRole">
                                Add
                            </v-btn>
...
const emit = defineEmits(['add-role']);
...
const addRole = () => {
    overlay.value = false;
    emit('add-role', { roleData: newRole.value, permissionsData: permissions.value.permissionsToAdd });
};
...
const clearPermissions = () => {
    permissions.value.permissionsToAdd = [];
}
